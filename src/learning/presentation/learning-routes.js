...
const learningRoutes = [
    { path: 'quizzes',             name: 'learning-quizzes',         component: quizList,    meta: { title: 'Quiz Bank', requiresRole: 'Coordinator'    } },
    { path: 'quizzes/new',         name: 'learning-quizzes-new',     component: quizForm,    meta: { title: 'New Quiz', requiresRole: 'Coordinator'     } },
    { path: 'quizzes/:id/edit',    name: 'learning-quizzes-edit',    component: quizForm,    meta: { title: 'Edit Quiz', requiresRole: 'Coordinator'    } },
