        ...
        <div v-else class="table-card">
          <pv-data-table
            ...
            <pv-column :header="t('transactions.original-amount')" field="amountSent" sortable>
              <template #body="slotProps">
                <span class="text-balance">
                  {{ wallet.currency }} {{ Number(slotProps.data.amountSent).toFixed(2) }}
                </span>
              </template>
            </pv-column>
            ...
            <pv-column :header="t('transactions.commission-fee')">
              <template #body="slotProps">
                <span class="text-commission">
                  - {{ wallet.currency }} {{ Number(slotProps.data.platformFee).toFixed(2) }}
            ...
            <pv-column :header="t('transactions.net-amount')">
              <template #body="slotProps">
                <span class="text-net">
                  {{ wallet.currency }} {{ Number(slotProps.data.amountReceived).toFixed(2) }}
                </span>
              </template>
            </pv-column>
